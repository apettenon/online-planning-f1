import numpy as np
import copy
from utils.helpers import (argmax, is_atari_game, copy_atari_state, restore_atari_state, stable_normalizer)
    ...
    def random_rollout(self, budget, env, max_depth):
        ...
        while t < max_depth and budget > 0 and not done:
            if hasattr(env, 'get_available_actions'):
                # Assuming single-agent mode where we can grab get_next_agent()
