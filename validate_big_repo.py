"""
Validation script for the big (original) repo.
...
Run from the project root: python validate_big_repo.py
"""
...
# Project root is the CWD when running this script
ROOT = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, ROOT)

from envs.race_strategy_event import RaceEnv
from interpretable_mcts.mcts_dpw import MCTSStochastic

BUDGET    = 500      # simulator calls per lap (kept small for speed)
GAMMA     = 1.0
C_UCB     = 1.2
MAX_DEPTH = 15
ALPHA     = 0.6      # DPW exponent
HORIZON   = 70       # max laps
...
def run():
    print("=" * 60)
    print("BIG REPO VALIDATION — Catalunya 2017, single agent")
    print("=" * 60)
    ...
    # Approximate raw race time: reward = 1 - lap_time/300, so lap_time = (1-r)*300
