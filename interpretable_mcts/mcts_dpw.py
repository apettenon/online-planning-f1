...
from interpretable_mcts.keyset import KeySet
from interpretable_mcts.mcts import MCTS, Action, State
...
class MCTSStochastic(MCTS):
    ...
    def search(self, n_mcts, c, Env, mcts_env, budget, max_depth=200):
        ...
        # Signature check removed: np.array_equal cannot compare non-array
        # signature fields (deques, sets, defaultdicts). deepcopy is relied upon
        # directly. Lean-repo equivalent already omits this block.
